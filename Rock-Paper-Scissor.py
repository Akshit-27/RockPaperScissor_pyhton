...
def exit():
    ...
    if (msg == True):
        ...
        pass
def logic():
    if user == "rockp2.png" and computer == "rockp1.png" or user == "paper-p2.png" and computer == "paper-p1.png" or user == "scissor-p2.png" and computer == "scissorp1.png":
        print(f"Both players selected {user_possible_moves}. It's a tie!")
